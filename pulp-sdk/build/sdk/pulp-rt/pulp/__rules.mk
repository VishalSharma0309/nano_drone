...
PULP_FC_EXTRA_SRCS_rt = /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_conf.c /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_pad_conf.c
...
PULP_LIB_NAME_rt ?= rt
PULP_LIB_TARGET_NAME_rt ?= lib$(PULP_LIB_NAME_rt).a

$(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_rt).a: $(rt_OBJS)  $(PULP_SDK_INSTALL)/rules/tools.mk
	@mkdir -p `dirname $@`
	@rm -f $@
	$(PULP_AR) -r $@ $^

$(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_rt): $(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_rt).a
	@mkdir -p `dirname $@`
	cp $^ $@ 
...
INSTALL_TARGETS += $(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_rt)
...
PULP_FC_EXTRA_SRCS_omp = /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_conf.c /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_pad_conf.c
...
PULP_LIB_NAME_omp ?= omp
PULP_LIB_TARGET_NAME_omp ?= lib$(PULP_LIB_NAME_omp).a

$(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_omp).a: $(omp_OBJS)  $(PULP_SDK_INSTALL)/rules/tools.mk
	@mkdir -p `dirname $@`
	@rm -f $@
	$(PULP_AR) -r $@ $^

$(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_omp): $(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_omp).a
	@mkdir -p `dirname $@`
	cp $^ $@ 
...
INSTALL_TARGETS += $(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_omp)
...
PULP_FC_EXTRA_SRCS_rtio = /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_conf.c /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_pad_conf.c
...
PULP_LIB_NAME_rtio ?= rtio
PULP_LIB_TARGET_NAME_rtio ?= lib$(PULP_LIB_NAME_rtio).a

$(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_rtio).a: $(rtio_OBJS)  $(PULP_SDK_INSTALL)/rules/tools.mk
	@mkdir -p `dirname $@`
	@rm -f $@
	$(PULP_AR) -r $@ $^

$(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_rtio): $(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_rtio).a
	@mkdir -p `dirname $@`
	cp $^ $@ 
...
INSTALL_TARGETS += $(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_rtio)
...
PULP_FC_EXTRA_SRCS_bench = /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_conf.c /home/vishal/nano_drone/pulp-sdk/build/sdk/pulp-rt/pulp/rt_pad_conf.c
...
PULP_LIB_NAME_bench ?= bench
PULP_LIB_TARGET_NAME_bench ?= lib$(PULP_LIB_NAME_bench).a

$(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_bench).a: $(bench_OBJS)  $(PULP_SDK_INSTALL)/rules/tools.mk
	@mkdir -p `dirname $@`
	@rm -f $@
	$(PULP_AR) -r $@ $^

$(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_bench): $(CONFIG_BUILD_DIR)/lib$(PULP_LIB_NAME_bench).a
	@mkdir -p `dirname $@`
	cp $^ $@ 
...
INSTALL_TARGETS += $(PULP_SDK_INSTALL)/lib/pulp/$(PULP_LIB_TARGET_NAME_bench)
